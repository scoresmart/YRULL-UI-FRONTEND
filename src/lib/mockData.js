...
export const mockWorkspaces = [{ id: 'ws_001', name: 'Demo Workspace', created_at: daysAgo(120) }];
...
export const mockContacts = [
  {
    ...
    status: 'active',
    notes: 'Asked about pricing tiers.',
  ...
  },
  {
    ...
    status: 'active',
    notes: 'Interested in automations.',
    created_at: daysAgo(16),
    last_active_at: hoursAgo(4),
  },
  {
    id: 'ct_005',
    workspace_id: 'ws_001',
  ...
  },
  {
    ...
    status: 'active',
    notes: 'Asked for case study.',
    created_at: daysAgo(13),
    last_active_at: hoursAgo(10),
  },
  {
    id: 'ct_008',
    workspace_id: 'ws_001',
  ...
  },
  {
    ...
    first_name: 'Finn',
    last_name: 'Schmidt',
    email: 'finn.s@example.com',
    status: 'active',
    notes: 'Budget approved.',
    created_at: daysAgo(10),
    last_active_at: minutesAgo(25),
  },
  {
    id: 'ct_011',
    workspace_id: 'ws_001',
  ...
  },
  {
    id: 'ct_013',
    workspace_id: 'ws_001',
    phone: '+52 55 5342 1234',
    first_name: 'Valeria',
    last_name: 'Lopez',
    email: 'valeria.l@example.com',
    status: 'active',
    notes: 'High volume team.',
    created_at: daysAgo(7),
    last_active_at: hoursAgo(12),
  },
  {
    id: 'ct_014',
    workspace_id: 'ws_001',
...
export const mockAudiences = [
  {
    ...
    conditions: {
      ...
      rules: [
        ...
        { field: 'last_active', op: 'lt_days', value: 7 },
      ],
    },
  ...
  },
  {
    ...
    conditions: {
      match: 'any',
      rules: [
        { field: 'tag', op: 'eq', value: 'Warm' },
        { field: 'tag', op: 'eq', value: 'Follow Up' },
      ],
    },
...
export const mockRules = [
  {
    ...
    workspace_id: 'ws_001',
    name: 'VIP → Assign Ava',
    condition: { field: 'tag', op: 'eq', value: 'VIP' },
    action: { type: 'assign', to: 'Ava Martinez' },
    status: 'active',
    triggered_count: 19,
  ...
  },
  {
    id: 'rule_002',
    workspace_id: 'ws_001',
    name: 'Warm → Follow Up in 24h',
    condition: { field: 'tag', op: 'eq', value: 'Warm' },
    action: { type: 'task', value: 'Follow up in 24h' },
    status: 'active',
    triggered_count: 41,
  ...
  },
  {
    ...
    workspace_id: 'ws_001',
    name: 'DNC → Block',
    condition: { field: 'tag', op: 'eq', value: 'Do Not Contact' },
    action: { type: 'status', value: 'blocked' },
    status: 'active',
    triggered_count: 3,
  ...
  },
  {
    id: 'rule_004',
    workspace_id: 'ws_001',
    name: 'New Lead → Template A',
    condition: { field: 'tag', op: 'eq', value: 'New Lead' },
    action: { type: 'send_template', value: 'Template A' },
    status: 'paused',
    triggered_count: 12,
  ...
  },
  {
    ...
    condition: { field: 'time', op: 'between', value: ['18:00', '08:00'] },
    action: { type: 'send_template', value: 'After-hours' },
    status: 'active',
    triggered_count: 8,
    created_at: daysAgo(14),
  },
...
export const mockActivityLogs = [
  ...
  },
  {
    ...
    description: 'New contact added: Sophia Ng',
  ...
  },
  {
    ...
    user_id: 'user_001',
    action: 'message_sent',
    description: 'Sent message to Ethan Brooks',
  ...
  },
  {
    ...
    description: 'Automation triggered: Welcome New Lead',
  ...
  },
  {
    ...
    description: 'Noah Kim was deactivated',
  ...
  },
  {
    ...
    user_id: 'user_002',
    action: 'tag_applied',
    description: 'Applied tag VIP to Finn Schmidt',
  ...
  },
  {
    ...
    description: 'New inbound message from Amelia Chen',
  ...
  },
  {
    ...
    description: 'Updated contact notes for Maya Patel',
  ...
  },
  {
    ...
    user_id: 'user_002',
    action: 'rule_updated',
    description: 'Rule updated: Warm → Follow Up in 24h',
  ...
  },
  {
    ...
    user_id: 'user_001',
    action: 'message_sent',
    description: 'Sent message to Chloe Dubois',
  ...
  },
  {
    ...
    description: 'Audience created: Warm Pipeline',
  ...
  },
  {
    ...
    description: 'Imported contacts from CSV',
  ...
  },
  {
    ...
    user_id: 'user_admin_001',
    action: 'user_invited',
    description: 'Invited team member: priya@example.com',
    created_at: daysAgo(2),
  },
  {
    id: 'act_015',
    ...
    user_id: 'user_002',
    action: 'message_received',
    description: 'New inbound message from Oliver Reed',
  ...
  },
  {
    ...
    description: 'Conversation resolved: Sophia Ng',
    created_at: daysAgo(3),
  },
  {
    id: 'act_017',
  ...
  },
  {
    ...
    description: 'Paused automation: Re-engage 14d Inactive',
    created_at: daysAgo(5),
  },
  {
    id: 'act_019',
    ...
    user_id: 'user_002',
    action: 'note_added',
    description: 'Added internal note for Diego Rivera',
    created_at: daysAgo(5),
  },
  {
    id: 'act_020',
    ...
    user_id: 'user_001',
    action: 'message_sent',
    description: 'Sent message to Hana Sato',
    created_at: daysAgo(6),
  },
];
...
export const mockMessages = [
  ...thread(
    ...
    [
      ...
      {
        direction: 'outbound',
        content: 'Yes — triggers like tag applied, new contact, schedules, and more.',
        minAgo: 220,
      },
    ],
    'Sophia',
